...
<head>
  ...
  <title>Admin Dashboard   |  Edit Contracts</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Edit Contracts <small>About</small></h1>
        </div>
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>home">Dashboard</a></li>
        <li><a href="<?php echo base_url(); ?>contracts">Contracts</a></li>
        <li class="active">Edit Contratcts</li>
      </ol>
    </div>
  </section>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Edit Contratcts</h3>
            </div>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form class="" action="#" method="post">
                ...
                <input type="submit" class="btn btn-default" value="Update Contract">
              </form>
            </div>
          </div>
