...
<body>
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="<?php echo base_url(); ?>contracts">Contracts</a></li>
        </ul>
  ...
  <header id="header">
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Contracts <small>Manage Your Contracts</small></h1>
        </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="<?php echo base_url(); ?>clients" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Clients</a>
        ...
        <div class="col-md-9">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">Current Contracts</h3>
            </div>
            <div class="panel-body">
              <br>
              <table class="table table-striped table-hover">
                <tr>
                  ...
                  <td>Active</td>
                  <td>01/01/2020</td>
                  <td><a class="btn btn-default" href="<?php echo base_url(); ?>editcontracts">Edit</a> <a class="btn btn-danger" href="#">Delete</a></td>
              </table>
            </div>
          </div>
